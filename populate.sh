...
curl -L https://libisl.sourceforge.io/isl-0.26.tar.bz2 | tar -xjf -
...
curl -L https://github.com/ccache/ccache/releases/download/v4.10.2/ccache-4.10.2.tar.xz | tar xJf -
